                                ...
                                <table class="table">
                                    ...
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>{{$user->name}}</td>
                                            <td>{{$user->email}}</td>
                                            <td><b>{{strtoupper($user->security_level)}}</b></td>
                                            <td>
                                                ...
                                                <form method="post" action="{{route('user.destroy',[$user->id])}}" class="btn btn-outline-danger deleteForm{{$user->id}}" onclick="confirmDeleted({{$user->id}})">
                                                    @csrf
                                                    @method('delete')
