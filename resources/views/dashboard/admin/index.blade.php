                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Administrators</h3>
                        </div>
                        <div class="card-title">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($administrators as $administrator)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('administrator.edit',[$administrator->id])}}" class="btn btn-outline-primary">
                                                ...
                                                <form method="post" action="{{route('administrator.destroy',[$administrator->id])}}" class="btn btn-outline-danger deleteForm{{$administrator->id}}" onclick="confirmDeleted({{$administrator->id}})">
                                                    @csrf
                                                    @method('delete')
    ...
    <script>
        function confirmDeleted(id){
            ...
            swalWithBootstrapButtons.fire({
                title: 'Are you sure ?!',
                text: "You are delete the administrator",
                icon: 'warning',
